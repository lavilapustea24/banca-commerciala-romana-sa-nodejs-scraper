/**
 * BCR Job Validator - Check and remove expired jobs
 * 
 * Validates all BCR jobs from peviitor API and deletes expired (404) ones from SOLR.
 * Run: node tests/validate-bcr-jobs.js
 */
...
const COMPANY_NAME = "BANCA COMERCIALĂ ROMÂNĂ SA";

/**
 * Get all jobs for BCR from peviitor API
 */
